...
class ProducersControllerTest < ActionController::TestCase
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post :create, producer: { address: @producer.address, dni: @producer.dni, last_name: @producer.last_name, name: @producer.name, renapa: @producer.renapa, telephone: @producer.telephone }
    end
  ...
  test "should update producer" do
    patch :update, id: @producer, producer: { address: @producer.address, dni: @producer.dni, last_name: @producer.last_name, name: @producer.name, renapa: @producer.renapa, telephone: @producer.telephone }
    assert_redirected_to producer_path(assigns(:producer))
  end
